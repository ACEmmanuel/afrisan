...
const Hero = () => {
  return (
    <>
        <div className='container mx-auto mt-[7rem] lg:mt-[11rem] grid place-content-center p-5 mb-[22rem]'>

            <h1 className='mb-4 text-4xl md:text-5xl lg:text-6xl font-mont font-extrabold text-center tracking-tight '>EXPLORE AFRICAN-MADE EXCELLENCE</h1>
