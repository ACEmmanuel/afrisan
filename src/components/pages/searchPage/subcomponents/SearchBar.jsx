...
const SearchBar = ({setSearchResults, setError}) => {
  ...
  return (
    <>
      ...
      <div className="relative flex justify-center items-center mt-2 font-DM">
        <input
          type="text"
          onChange={terms}
        ...
        <svg class="w-6 h-6 text-gray-800 absolute right-[6%] cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" 
        onClick={clearInput}
        >
