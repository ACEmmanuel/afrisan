        ...
        <div className='bg-[#1A1C2C]'>
            ...
            <div className='w-[100%] mx-auto py-6'>
                <div className='flex flex-row flex-wrap gap-7 mx-auto justify-between text-[13px] px-3'>
                    ...
                    <div className='mx-auto md:mx-0 md:pt-0 border-slate-700 pt-4 '>
                        <p className='text-[12px]'>Copyright @ 2023 Afrisan. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
...
//                 <h1 className='font-bold text-[2rem]'>SYZN</h1>
...
//             <div className='space-y-6 lg:w-[33%]'>
//                 <p className='left-green relative font-bold'>CONTACT US</p>
...
//             <div className='space-y-6 lg:w-[33%]'>
//                 <p className='left-green relative font-bold'>SIGN UP FOR EMAIL UPDATES</p>
...
//                     <p className='text-[12px]'>Copyright @ 2023 Sokka. All rights reserved.</p>
//                 </div>
//             </div>
//         </div>
//     </div>
